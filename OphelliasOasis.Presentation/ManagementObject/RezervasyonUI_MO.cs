...
namespace OphelliasOasis.Presentation.ManagementObject
{
    public class RezervasyonUI_MO
    {
        ...
        private void BtnRezervasyonYap_Click(object sender, EventArgs e)
        {
            ...
            if(UI.deRezervasyonYapBaslangic.DateTime < DateTime.Now || UI.deRezervasyonYapBitis.DateTime < DateTime.Now)
            { XtraMessageBox.Show(
        ...
        private void BtnRezervasyonAraRezervasyonGuncelle_Click(object sender, EventArgs e)
        {
            ...
            if (UI.deRezervasyonGuncelleBaslangic.DateTime < DateTime.Now || UI.deRezervasyonGuncellBitis.DateTime < DateTime.Now)
            { XtraMessageBox.Show(
                    "Şuanlık bu hizmeti veremiyoruz.\n" +
                    "Lütfen daha sonra tekrar dneyiniz...\n(Geçmişe Yolculuk)"); return; }
            #endregion
